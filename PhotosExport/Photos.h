...
- (NSArray<PhotosMediaItem *> *) import:(NSArray<NSURL *> *)x into:(PhotosAlbum *)into skipCheckDuplicates:(BOOL)skipCheckDuplicates;  // Import files into the library
...
@property double altitude;  // The GPS altitude in meters.
@property (copy) NSArray<NSNumber *> *location;  // The GPS latitude and longitude, in an ordered list of 2 numbers.  Latitude in range -90.0 to 90.0, longitude in range -180.0 to 180.0.
